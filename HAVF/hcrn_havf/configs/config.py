...
__C.seed = 666
__C.model_name = 'multilevel'
__C.level = 'middle-vcrn'
__C.fuse_type = 'concat'
__C.useAudio = True
__C.ablation = 'None'
# training options
__C.train = edict()
...
__C.train.motion_dim = 2048
__C.train.word_dim = 300
__C.train.audio_dim = 2048
...
__C.train.appearance_flag = True
