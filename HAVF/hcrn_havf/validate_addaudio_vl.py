...
from DataLoader_addaudio import VideoQADataLoader
...
if __name__ == '__main__':
    ...
    if cfg.dataset.name == 'tgif-qa':
        ...
        cfg.dataset.test_question_pt = '{}_test_RoBERTa_questions.pt'
        ...
        cfg.dataset.question_type = 'action'
        cfg.dataset.appearance_feat = '{}_appearance_{}_feat.h5'
        cfg.dataset.motion_feat = '{}_motion_{}_feat.h5'
        cfg.dataset.vocab_json = '{}_vocab.json'
    ...
    test_loader_kwargs = {
        ...
        'question_pt': '/DATA/DATANAS1/yangpinci/VGGSound_QA/hcrn-videoqa/data/vggsound-qa/vggsound-qa_val_questions.pt',
        'vocab_json': '/DATA/DATANAS1/yangpinci/VGGSound_QA/hcrn-videoqa/data/vggsound-qa/vggsound-qa_vocab.json',
