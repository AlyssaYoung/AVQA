...
import model.HCRN_addaudio_cl as HCRN
...
def train(cfg):
    ...
    train_loader_kwargs = {
        ...
        'question_pt': '/DATA/DATANAS1/yangpinci/VGGSound_QA/hcrn-videoqa/data/datasets/vggsound-qa/vggsound-qa_train_questions.pt',
    ...
    if cfg.val.flag:
        val_loader_kwargs = {
            'question_type': cfg.dataset.question_type,
            'question_pt': '/DATA/DATANAS1/yangpinci/VGGSound_QA/hcrn-videoqa/data/datasets/vggsound-qa/vggsound-qa_val_questions.pt',
            'vocab_json': cfg.dataset.vocab_json,
            'appearance_feat': cfg.dataset.appearance_feat,
            'motion_feat': cfg.dataset.motion_feat,
            'vl_audio_feat': '/DATA/DATANAS1/yangpinci/VGGSound_QA/preprocess_audio/vggsound-qa_vlaudio_PANNs_feat.h5',
...
def main():
    ...
    if cfg.dataset.name == 'tgif-qa':
        ...
        cfg.dataset.train_question_pt = '{}_train_questions_small.pt'
        cfg.dataset.val_question_pt = '{}_val_questions_small.pt'
        cfg.dataset.train_question_pt = os.path.join(cfg.dataset.data_dir,
