...
import sys
sys.path.append('..')
from data.dataloader.DataLoader import VideoQADataLoader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--motion_feat', default='resnet101', type=str)
    ...
    test_loader_kwargs = {
        ...
        'shuffle': False,
        'sent_dim':cfg.train.sent_dim,
        'augment': False
    }
    test_loader = VideoQADataLoader(**test_loader_kwargs)
    model_kwargs.update({'vocab': test_loader.vocab, 'ans_count':cfg.dataset.ans_count})
